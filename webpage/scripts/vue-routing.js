...
Vue.component('timecalc', { template: '<div><h2>Zeitrechner</h2><form><input type="text" id="hour" style="width:60px;"> : <input type="text" id="minute" style="width:60px;"><br><br><button type="button" onclick="timeById()" class="btn btn-dark">calculate</button></form><div id="ausgabe"></div></div>'});
